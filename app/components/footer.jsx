...
// --- START: Your new Card component and styles ---

const Card = () => {
  return (
    <StyledWrapper>
      <div className="card">
        <img src="https://uiverse.io/astronaut.png" alt="Floating astronaut" className="image" />
...
// --- END: Your new Card component and styles ---


// --- START: Footer layout (unchanged) ---

export function Footer() {
    return (
        <footer className="w-full bg-background border-t border-border py-12 px-4 animate-fade-in-up">
            <div className="max-w-6xl mx-auto flex flex-col items-center gap-12">
                <div className="w-full flex flex-col md:flex-row justify-around items-center gap-16 md:gap-8">
                    <div className="flex flex-col items-center md:items-start text-center md:text-left gap-7">
                        <h3 className="font-headline text-3xl font-extrabold text-foreground mb-1 relative after:content-[''] after:block after:w-16 after:h-1 after:bg-primary after:rounded-full after:mx-auto md:after:mx-0 after:mt-3">
                            Get In Touch
                        </h3>
                        <p className="text-foreground/80 dark:text-foreground/70 max-w-lg">
                        ...
                        <div className="flex flex-row gap-7 justify-center items-center">
                            <Link href="mailto:surya232043@gmail.com" aria-label="Email" className="group">
                                <span className="flex items-center justify-center h-14 w-14 rounded-full bg-muted/40 dark:bg-muted/20 transition-all duration-300 group-hover:bg-red-600 group-hover:shadow-[0_0_16px_4px_rgba(220,38,38,0.4)] group-hover:ring-4 group-hover:ring-red-400/40 group-hover:scale-110">
                                    <Mail className="h-8 w-8 text-foreground/80 dark:text-foreground/70 group-hover:text-white transition-colors" />
                                </span>
                            </Link>
                            <Link href="https://github.com/itxx-suryaah" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="group">
                                <span className="flex items-center justify-center h-14 w-14 rounded-full bg-muted/40 dark:bg-muted/20 transition-all duration-300 group-hover:bg-black group-hover:shadow-[0_0_16px_4px_rgba(0,0,0,0.4)] group-hover:ring-4 group-hover:ring-black/40 group-hover:scale-110">
                                    <Github className="h-8 w-8 text-foreground/80 dark:text-foreground/70 group-hover:text-white transition-colors" />
                                </span>
                            </Link>
                            <Link href="https://www.linkedin.com/in/surya-b-com-ca-6b73b1292?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="group">
                                <span className="flex items-center justify-center h-14 w-14 rounded-full bg-muted/40 dark:bg-muted/20 transition-all duration-300 group-hover:bg-blue-600 group-hover:shadow-[0_0_16px_4px_rgba(37,99,235,0.4)] group-hover:ring-4 group-hover:ring-blue-400/40 group-hover:scale-110">
                                    <Linkedin className="h-8 w-8 text-foreground/80 dark:text-foreground/70 group-hover:text-white transition-colors" />
                                </span>
                            </Link>
                            <Link href="https://www.instagram.com/itxx_suryaah?igsh=ZXc1azh2MXk5bmtq" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="group">
                                <span className="flex items-center justify-center h-14 w-14 rounded-full bg-muted/40 dark:bg-muted/20 transition-all duration-300 group-hover:bg-purple-600 group-hover:shadow-[0_0_16px_4px_rgba(147,51,234,0.4)] group-hover:ring-4 group-hover:ring-purple-400/40 group-hover:scale-110">
                                    <Instagram className="h-8 w-8 text-foreground/80 dark:text-foreground/70 group-hover:text-white transition-colors" />
                                </span>
                            </Link>
                        </div>
                    </div>
                ...
                <p className="text-xs text-muted-foreground dark:text-muted-foreground/80 text-center w-full pt-4">
